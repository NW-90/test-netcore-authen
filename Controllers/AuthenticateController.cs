...
using test_authorize.Authentication;

namespace test_authorize.Controllers
{
    ...
    public class AuthenticateController : ControllerBase
    {
        ...
        public async Task<IActionResult> RegisterAdmin([FromBody] RegisterModel model)
        {
            ...
            if (userExists != null)
            {
                return StatusCode(StatusCodes.Status500InternalServerError, new Response { Status = "Error", Message = "User already exsts!!" });
            }
            ApplicationUser user = new ApplicationUser()
            {
                Email = model.Email,
            ...
            return Ok(new Response { Status = "Suceess", Message = "User created successfully" });
        }
    }
}